...
Consolidated from all feature plans. Last updated: 2026-09-06
...
- T020–T023 and T025–T026 are accepted: offline reviewed/automatic selection CLI, guarded SAM adapter and mask/alpha/glyph artifacts, native masked compilation and CPU composition. Core has no Torch dependency. T027 is accepted on macOS with pinned ComfyUI in an isolated letsaigc-comfy CPU environment, native-node/process verification, and no generation. Real SAM validation (T024), editing workflow execution (T028), and full quality acceptance remain pending; locked SAM CUDA resources are not prepared on this Mac.
